...
import org.whcraft.whcraft.Items.ServoSkull.*;
...
public class WhcraftItems {
    ...
    public static final Item SERVO_SKULL_RETROFIT = register("servo_skull_retrofit", new ServoSkullRetrofit(new Item.Settings().maxCount(1)));
    ...
    public static void registerCustomIngredient() {
        ...
        CustomIngredientSerializer.register(ServoSkullRetrofitIngredient.Serializer.INSTANCE);
    }
    ...
    private static void registerRecipeSerializers() {
        Registry.register(Registries.RECIPE_SERIALIZER, RetrofitCraftingRecipeSerializer.ID, RetrofitCraftingRecipeSerializer.INSTANCE);
    }
