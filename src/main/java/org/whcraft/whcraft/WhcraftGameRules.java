...
public class WhcraftGameRules {
     ...
     * false: 不可能
     */
    public static final GameRules.Key<GameRules.BooleanRule> CAN_IMPLANTATION_FAIL =
            GameRuleRegistry.register("canImplantationFail", GameRules.Category.PLAYER,
                    GameRuleFactory.createBooleanRule(true));

    /**
     * 定义改造后是否保留用于改造的基因种子。<br/>
     * true: 保留，改造后不消耗。
     * false: 不保留，改造会消耗基因种子。（默认）
     */
    public static final GameRules.Key<GameRules.BooleanRule> KEEP_GENE_SEED_AFTER_IMPLANTATION =
            GameRuleRegistry.register("keepGeneSeedAfterImplantation", GameRules.Category.PLAYER,
                    GameRuleFactory.createBooleanRule(false));

    /**
     * 定义武装伺服头骨的攻击伤害（默认 6，至少 0）。
     */
    public static final GameRules.Key<GameRules.IntRule> SERVO_SKULL_ATTACK_DAMAGE =
            GameRuleRegistry.register("servoSkullAttackDamage", GameRules.Category.PLAYER,
                    GameRuleFactory.createIntRule(6, 0));

    /**
     * 定义武装伺服头骨的自爆威力（默认 15，至少 1）。
     */
    public static final GameRules.Key<GameRules.IntRule> SERVO_SKULL_SELF_DESTRUCT_POWER =
            GameRuleRegistry.register("servoSkullSelfDestructPower", GameRules.Category.PLAYER,
                    GameRuleFactory.createIntRule(15, 1));

    /**
     * 定义武装伺服头骨攻击冷却（默认 40 ticks，至少 1）。
     */
    public static final GameRules.Key<GameRules.IntRule> SERVO_SKULL_ATTACK_COOLDOWN =
            GameRuleRegistry.register("servoSkullAttackCooldown", GameRules.Category.PLAYER,
                    GameRuleFactory.createIntRule(40, 1));

    /**
     * 定义医疗伺服头骨医疗冷却（默认 300 ticks，至少 1）。
     */
    public static final GameRules.Key<GameRules.IntRule> SERVO_SKULL_HEALTHCARE_COOLDOWN =
            GameRuleRegistry.register("servoSkullHealthcareCooldown", GameRules.Category.PLAYER,
                    GameRuleFactory.createIntRule(300, 1));
