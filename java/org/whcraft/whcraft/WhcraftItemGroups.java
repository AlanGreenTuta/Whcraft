...
public class WhcraftItemGroups {
    public static final ItemGroup WHCRAFT_GROUP = Registry.register(Registries.ITEM_GROUP, new Identifier("whcraft", "whcraft_group"), FabricItemGroup.builder()
    ...
    public static final ItemGroup WHCRAFT_NECRON_BUILDING_BLOCKS_GROUP = Registry.register(
            Registries.ITEM_GROUP,
            new Identifier("whcraft", "whcraft_necron_building_blocks_group"),
            FabricItemGroup.builder()
                    .icon(() -> new ItemStack(WhcraftBlocks.NECRON_TOMB_WALL_BLOCK))
                    .displayName(Text.translatable("itemGroup.whcraft_necron_building_blocks_group"))
                    .entries((context, entries) -> {
                        //在此添加物品组中的物品（和方块）
